...
import { subcategoryList } from 'src/app/shared/model/page.model';
...
export class SubcategorylistComponent {
  initChecked = false;
  public tableData: Array<subcategoryList> = [];
  ...
  public totalData = 0;
  showFilter = false;
  dataSource!: MatTableDataSource<subcategoryList>;
  ...
  private getTableData(pageOption: pageSelection): void {
    this.data.getSubcategoryList().subscribe((apiRes: apiResultFormat) => {
      ...
      apiRes.data.map((res: subcategoryList, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<subcategoryList>(this.tableData);
